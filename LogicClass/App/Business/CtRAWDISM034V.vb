...
Namespace App.Business
    Partial Public Class CtRAWDISM034V
...
#Region "建構子"
        ...
        Public Sub New(ByVal dbManager As DBManager, ByVal logUtil As LogUtil)
            ...
            Me.ENT_RAWDISM034V = New ENT_RAWDISM034V(Me.DBManager, Me.LogUtil)
        End Sub
#End Region


#Region "屬性"
#Region "ENT_RAWDISM034V"
        ' <summary>ENT_RAWDISM031V</ summary>
        Private Property ENT_RAWDISM034V() As ENT_RAWDISM034V
            Get
                Return Me.PropertyMap("ENT_RAWDISM034V")
            End Get
            Set(ByVal value As ENT_RAWDISM034V)
                Me.PropertyMap("ENT_RAWDISM034V") = value
            End Set
        End Property
#End Region
...
#Region "DoQuery 進行查詢動作"
        ...
        Public Function DoQuery() As DataTable
            Try
                ...
                Me.ENT_RAWDISM034V.SqlRetrictions = condition.ToString()
                ...
                Else
                    Me.ENT_RAWDISM034V.OrderBys = Me.OrderBys
                End If

                Dim result As DataTable
                If Me.PageNo = 0 Then
                    result = Me.ENT_RAWDISM034V.Query()
                Else
                    result = Me.ENT_RAWDISM034V.Query(Me.PageNo, Me.PageSize)
                    Me.TotalRowCount = Me.ENT_RAWDISM034V.TotalRowCount
                End If
        ...
        Public Function DoQuerySQL(ByVal IDENTIFICATION As String) As DataTable
            Try
                ...
                Dim result As DataTable
                'If Me.PageNo = 0 Then
                result = Me.ENT_RAWDISM034V.QueryBySql(String.Format(" SELECT top 1 * From RAWDISM034V Where IDENTIFICATION='{0}'", IDENTIFICATION))
        ...
        Public Function GetMaxDate() As DataTable
            Try
                ...
                Dim result As DataTable
                If Me.PageNo = 0 Then
                    result = Me.ENT_RAWDISM034V.GetMaxDate()
                Else
                    result = Me.ENT_RAWDISM034V.GetMaxDate(Me.PageNo, Me.PageSize)
                    Me.TotalRowCount = Me.ENT_RAWDISM034V.TotalRowCount
                End If
