'ProductName                 : TSBA 
'File Name					 : CtAPP1020 
'Description	             : CtAPP1020 外國人直接持有之股份
'Modification Log	:
'
'Vers           Date        By          Notes
'---------------------------------------------------------------------------
...
Namespace App.Business
    Partial Public Class CtAPP1020
...
#Region "建構子"
        ...
        Public Sub New(ByVal dbManager As DBManager, ByVal logUtil As LogUtil)
            ...
            Me.Ent_APP1020 = New ENT_APP1020(Me.DBManager, Me.LogUtil)
        End Sub
#End Region
...
#Region "Ent_APP1020"
        ' <summary>Ent_APP1020</ summary>
        Private Property Ent_APP1020() As ENT_APP1020
            Get
                Return Me.PropertyMap("Ent_APP1020")
            End Get
            Set(ByVal value As ENT_APP1020)
                Me.PropertyMap("Ent_APP1020") = value
            End Set
        End Property
#End Region
...
#Region "DoAdd 處理新增資料動作"
        ...
        Public Function DoAdd() As String
            Try
                ...
                '=== 設定屬性參數 ===
                Me.Ent_APP1020.CASE_NO = Me.CASE_NO      '案件編號
                Me.Ent_APP1020.FOREIGNER_SHOLDER_NM = Me.FOREIGNER_SHOLDER_NM        '外國股東名稱
                Me.Ent_APP1020.COUNTRY = Me.COUNTRY      '國籍
                Me.Ent_APP1020.DIRECT_SHAREHOLDING = Me.DIRECT_SHAREHOLDING      '外國人直接持有之股份
                Me.Ent_APP1020.PROPORTION = Me.PROPORTION        '所佔比例


                '=== 設定處理新增動作 ===
                Dim result As String = Me.Ent_APP1020.Insert()
...
#Region "DoModify 處理修改資料動作"
        ...
        Public Function DoModify() As Integer
            Try
                ...
                Me.Ent_APP1020.SqlRetrictions = Me.ProcessCondition(condition.ToString())


                '=== 處理修改資料動作 ===
                Dim updateCount = Me.Ent_APP1020.Update()
...
#Region "DoDelete 處理刪除資料動作"
        ...
        Public Sub DoDelete()
            Try
                ...
                '=== 刪除資料 ===
                If Me.Ent_APP1020.SqlRetrictions <> "" Then '安全避免沒有條件全刪
                    Me.Ent_APP1020.Delete()
                End If
...
#Region "DoQuery 進行查詢動作"
        ...
        Public Function DoQuery() As DataTable
            Try
                ...
                Me.ProcessQueryCondition(condition, "=", "DIRECT_SHAREHOLDING", Me.DIRECT_SHAREHOLDING)      '外國人直接持有之股份
                Me.ProcessQueryCondition(condition, "=", "PROPORTION", Me.PROPORTION)        '所佔比例

                Me.Ent_APP1020.SqlRetrictions = condition.ToString()


                If (String.IsNullOrEmpty(Me.OrderBys)) Then
                    Me.Ent_APP1020.OrderBys = "PKNO"
                Else
                    Me.Ent_APP1020.OrderBys = Me.OrderBys
                End If

                '=== 處理取得回傳資料===
                Dim result As DataTable
                If Me.PageNo = 0 Then
                    result = Me.Ent_APP1020.Query()
                Else
                    result = Me.Ent_APP1020.Query(Me.PageNo, Me.PageSize)
                    Me.TotalRowCount = Me.Ent_APP1020.TotalRowCount
                End If
