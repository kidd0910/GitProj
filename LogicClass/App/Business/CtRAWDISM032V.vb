...
Namespace App.Business
    Partial Public Class CtRAWDISM032V
...
#Region "建構子"
        ...
        Public Sub New(ByVal dbManager As DBManager, ByVal logUtil As LogUtil)
            ...
            Me.ENT_RAWDISM032V = New ENT_RAWDISM032V(Me.DBManager, Me.LogUtil)
        End Sub
#End Region


#Region "屬性"
#Region "ENT_RAWDISM032V"
        ' <summary>ENT_RAWDISM031V</ summary>
        Private Property ENT_RAWDISM032V() As ENT_RAWDISM032V
            Get
                Return Me.PropertyMap("ENT_RAWDISM032V")
            End Get
            Set(ByVal value As ENT_RAWDISM032V)
                Me.PropertyMap("ENT_RAWDISM032V") = value
            End Set
        End Property
#End Region
...
#Region "DoQuery 進行查詢動作"
        ...
        Public Function DoQuery() As DataTable
            Try
                ...
                Me.ENT_RAWDISM032V.SqlRetrictions = condition.ToString()
                ...
                Else
                    Me.ENT_RAWDISM032V.OrderBys = Me.OrderBys
                End If

                Dim result As DataTable
                If Me.PageNo = 0 Then
                    result = Me.ENT_RAWDISM032V.Query()
                Else
                    result = Me.ENT_RAWDISM032V.Query(Me.PageNo, Me.PageSize)
                    Me.TotalRowCount = Me.ENT_RAWDISM032V.TotalRowCount
                End If
        ...
        Public Function DoQuerySQL(ByVal IDENTIFICATION As String) As DataTable
            Try
                ...
                Dim result As DataTable
                'If Me.PageNo = 0 Then
                result = Me.ENT_RAWDISM032V.QueryBySql(String.Format(" SELECT top 1 * From RAWDISM032V Where IDENTIFICATION='{0}'", IDENTIFICATION))
        ...
        Public Function GetMaxDate() As DataTable
            Try
                ...
                Dim result As DataTable
                If Me.PageNo = 0 Then
                    result = Me.ENT_RAWDISM032V.GetMaxDate()
                Else
                    result = Me.ENT_RAWDISM032V.GetMaxDate(Me.PageNo, Me.PageSize)
                    Me.TotalRowCount = Me.ENT_RAWDISM032V.TotalRowCount
                End If
