...
#Region "Query 查詢 "
        ...
        Public Overrides Function Query(ByVal pageNo As Integer, ByVal pageSize As Integer) As DataTable
            Try
                ...
                '=== 處理別名 ===
                Me.TableCoumnInfo.Add(New String() {"RAWDISM032V", "M", "YY", "IDENTIFICATION", "APPLY_CHT_NAME", "LICENSE_NO1", "CHANNEL_NAME", "CNAME"})
                Me.ParserAlias()

                '=== Combine SQL ===
                Dim sql As New StringBuilder
                sql.AppendLine(" SELECT * FROM RAWDISM032V M ")
        ...
        Public Function GetMaxDate(ByVal pageNo As Integer, ByVal pageSize As Integer) As DataTable
            Try
                ...
                '=== 處理別名 ===
                Me.TableCoumnInfo.Add(New String() {"RAWDISM032V", "M", "YY", "CHANNEL_NAME", "IDENTIFICATION"})
                Me.ParserAlias()

                '=== Combine SQL ===
                Dim sql As New StringBuilder
                sql.AppendLine(" SELECT MAX(YY) as MAX_YY FROM RAWDISM032V M ")
